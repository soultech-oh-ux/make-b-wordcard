...
좋은 메시지(말씀·시·명언)와 사진으로 한 장의 카드를 만드는 웹앱. **무료 · 설치 없음 · 휴대폰 앱(PWA) 지원.**

## 기능
- 글귀 입력 + 성경 구절 선택(개역한글·WEB·KJV 자동 / 개역개정·NIV·쉬운성경 참조 자동)
- **추천 구절 400개** (20주제 × 20구절: 위로·평안·감사·찬양·믿음·사랑·소망·기도·지혜·순종·은혜·회개·전도·축복·치유·회복·능력·가정·용서·절기) + **구절 직접 입력**(예: `창세기 1:1`, `마 5:3-10`)
- 배경: 샘플 30종(앱이 직접 그림) · 무료 AI · 내 사진 · 사진검색(위키미디어+Openverse) · DALL·E/Gemini
- **캐릭터/스티커**: 귀여운 동물·성경 상징 이모지를 카드에 추가, 드래그로 위치 이동
- **⑤ 내 구절 모음**: 한글 본문을 직접 붙여넣어 자료실(이 기기에만 저장)로 보관, 클릭으로 카드에 즉시 채움
- **일괄 PNG ZIP 생성**: 모음 전체로 한 번에 카드 만들기(최대 365장+)
- 스타일 3종 · 비율 4종 · 한글 글꼴 7종 · 색/위치/흐림 조절
- PNG 저장 · **클립보드 복사** · 모바일 공유 · 설정 자동 저장
